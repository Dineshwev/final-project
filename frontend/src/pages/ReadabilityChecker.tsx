// src/pages/ReadabilityChecker.tsx
...
const ReadabilityChecker: React.FC = () => {
  ...
  const sampleTexts = {
    easy: "The cat sat on the mat. It was a big cat. The cat was black. The mat was red. The cat liked the mat.",
    medium:
      "Search engine optimization is a process that improves website visibility. It helps websites rank higher in search results. Good SEO practices include quality content and proper keywords.",
    complex:
      "The epistemological ramifications of poststructuralist hermeneutics necessitate comprehensive reevaluation of phenomenological methodologies within contemporary philosophical discourse.",
  };

  const loadSample = (type: keyof typeof sampleTexts) => {
